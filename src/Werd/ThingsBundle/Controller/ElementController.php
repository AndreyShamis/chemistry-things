...
namespace Werd\ThingsBundle\Controller;

use Symfony\Component\HttpFoundation\Request;
use Symfony\Bundle\FrameworkBundle\Controller\Controller;
use Sensio\Bundle\FrameworkExtraBundle\Configuration\Method;
use Sensio\Bundle\FrameworkExtraBundle\Configuration\Route;
use Werd\ThingsBundle\Entity\Element;
use Werd\ThingsBundle\Form\ElementType;
...
class ElementController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $elements = $em->getRepository('WerdThingsBundle:Element')->findAll();
    ...
    {
        $element = new Element();
        $form = $this->createForm('Werd\ThingsBundle\Form\ElementType', $element);
    ...
    {
        $deleteForm = $this->createDeleteForm($element);
        $editForm = $this->createForm('Werd\ThingsBundle\Form\ElementType', $element);
